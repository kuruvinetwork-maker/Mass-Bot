...
class Config(object):
    ...
    OWNER    = int(os.environ.get("OWNER", "8765809228"))  # ⚠️ Required
    SUDO = list(map(int, os.environ.get("SUDO", "8765809228").split()))    # ⚠️ Required
    # Web Response Config
...
<b>✦ » Tʜɪs ʙᴏᴛ ɪs sᴏʟᴇʟʏ ᴄʀᴇᴀᴛᴇ ᴏʀ ᴅᴇᴠᴇʟᴏᴘᴇᴅ ʙʏ :- <a href=t.me/KURUVI_BABY>ᴋᴜʀᴜᴠɪ ʙᴀʙʏ</a></b>
"""
...
**- 𝖢ʀᴇᴀᴛᴏʀ : <a href=t.me/KURUVI_BABY>ᡣ𐭩 ེ𝚱𝛖ɭꝛ᪳ᷱ𝛖𝐯𝛊𝁜ֶָ֪֯ 𝁘💋</a>**
**- 𝖫ɪʙʀᴀʀʏ : Pʏʀᴏɢʀᴀᴍ**
**- 𝖫ᴀɴɢᴜᴀɢᴇ : 𝖯ʏᴛʜᴏɴ 𝟥**
**- 𝖣ᴀᴛᴀʙᴀsᴇ : 𝖬ᴏɴɢᴏ ᴅʙ**
